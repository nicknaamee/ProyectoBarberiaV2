...
public class ProductoService {
    ...
    public Producto guardarNuevoProducto(Producto producto) {
        log.info("Guardando nuevo Producto (v2): {}", producto.getNombreDelProducto());
    ...
    public Producto actualizarProducto(Long idDelProducto, Producto datosNuevos) {
        log.info("Actualizando Producto (v2) con id: {}", idDelProducto);
