...
import com.BloqueNico.proyectoBarberia.assemblers.ReporteModelAssembler;
...
public class ReporteController {
    ...
    public ResponseEntity<EntityModel<ReporteDTO>> crearReporte(@Valid @RequestBody Reporte reporte) {
        try {
            Reporte nuevoReporte = reporteService.guardarNuevoReporte(reporte);
            ReporteDTO dto = reporteService.convertirAReporteDTO(nuevoReporte);
            
            return ResponseEntity
                    .created(linkTo(methodOn(ReporteController.class).obtenerPorId(dto.getIdReporte())).toUri())
