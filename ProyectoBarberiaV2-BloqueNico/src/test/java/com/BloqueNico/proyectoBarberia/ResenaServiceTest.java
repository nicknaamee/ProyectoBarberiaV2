...
class ResenaServiceTest {
    ...
    void testeoConveritrDTO() {
        ...
        Resena resena = new Resena();
        resena.setIdDeLaResena(10L);
        resena.setCliente(cliente);
        resena.setBarbero(barbero);
        resena.setCalificacionDeEstrellas(5);
        resena.setComentarioDelCliente("Excelente servicio");
        resena.setFechaDeLaResena(LocalDate.parse("2026-06-27"));

        ResenaDTO resultado = resenaService.convertirAResenaDTO(resena);

        assertNotNull(resultado);
        assertEquals(10L, resultado.getIdDeLaResena());
        assertEquals(1L, resultado.getIdDelClienteQueOpina());
        assertEquals(2L, resultado.getIdDelBarberoEvaluado());
        assertEquals(5, resultado.getCalificacionDeEstrellas());
        assertEquals("Excelente servicio", resultado.getComentarioDelCliente());
        assertEquals(LocalDate.parse("2026-06-27"), resultado.getFechaDeLaResena());
    }
