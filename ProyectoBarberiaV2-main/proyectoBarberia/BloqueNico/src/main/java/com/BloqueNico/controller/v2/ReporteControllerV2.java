...
public class ReporteControllerV2 {
    ...
    public ResponseEntity<CollectionModel<EntityModel<ReporteDTO>>> listarReportes() {
        ...
        return ResponseEntity.ok(CollectionModel.of(
                reportes,
                linkTo(methodOn(ReporteControllerV2.class).listarReportes()).withSelfRel()
        ));
    }
    ...
    public ResponseEntity<EntityModel<ReporteDTO>> crearReporte(@Valid @RequestBody ReporteDTO reporteDTO) {
        ...
        return ResponseEntity
                .created(linkTo(methodOn(ReporteControllerV2.class).obtenerPorId(dto.getIdDelReporte())).toUri())
